...
public enum RowBuilderType {
  String(String.class, new StringLexicoder()),
  Integer(int.class, new IntegerLexicoder()),
  Long(long.class, new LongLexicoder()),
  Float(float.class, new FloatLexicoder()),
  Double(double.class, new DoubleLexicoder()),
  Date(Date.class, new DateLexicoder()),
  Boolean(boolean.class, null),
  Bytes(byte[].class, new ByteEncoder()),
  Unknown(null, null);
